...
import 'package:ue_launcher/widgets/unreal_engine_display_item.dart';
...
class _InstalledEnginesState extends State<InstalledEngines> {
            ...
            Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => context.read<FoundEnginesData>().manuallyAddEngine(),
                ),
                IconButton(
                  icon: const Icon(Icons.refresh),
                  onPressed: () => context.read<FoundEnginesData>().tryLoadDefaultOrSavedEngine(),
                ),
              ],
            ),
            if (foundEnginesData.latestAvailableVersion != null && foundEnginesData.isUpdateAvailable)
              _buildUpdateBanner(context, foundEnginesData),
            _buildEngineList(context, foundEnginesData),
          ],
        );
      },
    );
  ...
  Widget _buildUpdateBanner(BuildContext context, FoundEnginesData data) {
    return Padding(
  ...
  Widget _buildEngineList(BuildContext context, FoundEnginesData data) {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return UnrealEngineDisplayItem(engineInfo: data.foundEngines[index]);
        },
      ),
    );
  }
      ...
      children: [
        MouseRegion(
          ...
          child: GestureDetector(
            onTap: () => context.read<FoundEnginesData>().triggerEngineInstallation(''),
            child: Container(
              width: 240,
              height: 106,
